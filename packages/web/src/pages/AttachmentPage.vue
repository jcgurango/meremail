...
async function loadAttachment() {
  ...
  try {
    const response = await fetch(`/api/attachments/${route.params.id}/details`)
    if (response.ok) {
      attachment.value = await response.json() as Attachment
    } else {
      ...
      <div class="context-section">
        ...
        <div class="context-item">
          ...
          <div class="context-value">
            <RouterLink v-if="attachment.thread" :to="`/thread/${attachment.thread.id}`">
        ...
        <div v-if="attachment.sender" class="context-item">
          ...
          <div class="context-value">
            <RouterLink :to="`/contact/${attachment.sender.id}`">
